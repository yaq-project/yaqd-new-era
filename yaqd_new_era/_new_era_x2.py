...
=======
        ...
        addr = int(config["address"])
>>>>>>> d001f4ffe9ad2a05e6a6c22a0ab7c1ffe63f672a
        if (addr > 9) or (addr < -1):
            ...
            if True:  #held in place for a self.closing read if needed
                ...
                if prompt is not None:
                    ...
                    if (prompt == "I") or (prompt=="W"):
                        ...
                        self._state["position_identifier"]=self.get_position_identifier_options()[1]
                    else:
                        self._state["position"]=0.0
                        self._state["position_identifier"]=self.get_position_identifier_options()[0]
                    #self._state["current_alarm"]=""
                if alarm is not None:
                    if ((alarm != self._state["current_alarm"]) and (self._state["current_alarm"] != "U") ):
